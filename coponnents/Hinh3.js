    ...
    return (
      <View style={styles.container}>
        <View style={styles.contents}>
          <Text style={styles.txtTitle}>PASSWORD<br/>GENERATOR</Text>
          ...
          <View style={styles.viewChooses}>
            <View style={styles.viewChoose}>
              ...
              <TextInput style={{width : '120px', height : '33px', backgroundColor : 'white', fontSize : '20px', fontWeight : 'bold'}}
              value={length}
            ...
            <View style={styles.viewChoose}>
              ...
              <CheckBox style={styles.checkbox} value={isLowerCase} onValueChange={() => setIsLowerCase(!isLowerCase)}/>
            </View>
            <View style={styles.viewChoose}>
              <Text style={styles.txtChoose}>Include upcase letters</Text>
              <CheckBox style={styles.checkbox} value={isUpCase} onValueChange={() => setIsUpCase(!isUpCase)}/>
            </View>
            <View style={styles.viewChoose}>
              <Text style={styles.txtChoose}>Include number</Text>
              <CheckBox style={styles.checkbox} value={isNumber} onValueChange={() => setIsNumber(!isNumber)}/>
            </View>
            <View style={styles.viewChoose}>
